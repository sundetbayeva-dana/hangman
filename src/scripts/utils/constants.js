...
for (let i = 1072; i <= 1103; i += 1) {
  alphabetString += String.fromCodePoint(i);
}
...
const questions = [
  ...
  },
  {
    id: 3,
    question:
      "В каком фильме Хью Джекман сыграл фокусника, соперника персонажа, которого сыграл Кристиан Бэйл?",
    answer: "престиж",
  },
  {
    id: 4,
  ...
  },
  {
    id: 5,
    question:
      "В 1930 году Альберту Эйнштейну и его коллеге был выдан патент США 1781541. Для чего он был?",
    answer: "холодильник",
  },
  {
    id: 6,
  ...
  },
  {
    id: 9,
    question:
      "Граффити происходит от итальянского слова «граффиато», что означает что?",
    answer: "царапины",
  },
  {
    id: 10,
